...
```
![image](https://github.com/Suthera213/OOP2565-Week-10/assets/115066359/12563b21-fb6b-406e-9228-bf31b251c60b)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-10/assets/115066359/025bed3e-43db-42d6-ad11-286f55a1e27a)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-10/assets/115066359/93df34e8-d87e-48c6-b9cb-5d8dff4c6e8c)
...
และถ้าโค้ดที่เป็น base class ได้รับการอัพเดต derived class ก็จะถูกอัพเดตตามไปด้วยซึ่งถ้าเราเขียนโค้ดเดิมซ้ำหลายๆครั้งหรือ coppy code มาแก้ไขเราจำเป้นต้องแก้ไขโค้ดนั้นๆทั้งหมด
```
